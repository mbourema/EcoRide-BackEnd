 ...
 */
final class Version20250213210846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE covoiturage (covoiturage_id INT AUTO_INCREMENT NOT NULL, date_depart DATETIME NOT NULL, lieu_depart VARCHAR(100) NOT NULL, date_arrivee DATETIME NOT NULL, lieu_arrivee VARCHAR(100) NOT NULL, statut VARCHAR(50) NOT NULL, nb_places INT NOT NULL, prix_personne DOUBLE PRECISION NOT NULL, photo LONGBLOB DEFAULT NULL, voiture_id INT NOT NULL, conducteur_id INT NOT NULL, pseudo_conducteur INT NOT NULL, email_conducteur INT NOT NULL, INDEX IDX_28C79E89181A8BA (voiture_id), INDEX IDX_28C79E89F16F4AC6 (conducteur_id), INDEX IDX_28C79E89FBA76D03 (pseudo_conducteur), INDEX IDX_28C79E898FD4839C (email_conducteur), PRIMARY KEY(covoiturage_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE paiement (paiement_id INT AUTO_INCREMENT NOT NULL, montant DOUBLE PRECISION NOT NULL, date_paiement DATETIME NOT NULL, avancement VARCHAR(255) NOT NULL, utilisateur_id INT NOT NULL, covoiturage_id INT NOT NULL, INDEX IDX_B1DC7A1EFB88E14F (utilisateur_id), INDEX IDX_B1DC7A1E62671590 (covoiturage_id), PRIMARY KEY(paiement_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE utilisateur (utilisateur_id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, email VARCHAR(50) NOT NULL, nb_credit DOUBLE PRECISION DEFAULT 20 NOT NULL, mdp VARCHAR(255) NOT NULL, telephone VARCHAR(20) NOT NULL, adresse VARCHAR(100) NOT NULL, date_naissance DATE NOT NULL, pseudo VARCHAR(50) NOT NULL, photo LONGBLOB DEFAULT NULL, fumeur TINYINT(1) DEFAULT 0 NOT NULL, animal TINYINT(1) DEFAULT 0 NOT NULL, preference VARCHAR(100) NOT NULL, api_token VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), UNIQUE INDEX UNIQ_1D1C63B386CC499D (pseudo), PRIMARY KEY(utilisateur_id)) DEFAULT CHARACTER SET utf8mb4');
